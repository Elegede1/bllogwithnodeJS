...
router.post('/', blogController.blog_create_post); // define the route for the create page. This will be used to create a new blog. The blogController.blog_create_post function will be called when this route is accessed.


router.get('/create', blogController.blog_create_get); // define the route for the create page. This will be used to display the form to create a new blog. The blogController.blog_create_get function will be called when this route is accessed.
...
router.delete('/:id', blogController.blog_delete); // define the route for the delete page. This will be used to delete a blog. The blogController.blog_delete function will be called when this route is accessed.
