...
router.get('/:id', ensureAuthenticated, blogController.blog_details); // define the route for the details page. This will be used to display a single blog. The blogController.blog_details function will be called when this route is accessed.
